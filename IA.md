# Local codebase at /Users/riyaghosh/V2 cloned/Mirai — a React 18 + Vite 5 + Tailwind v3 reference clone of Mirai Labs' live marketing site. Content, branding and design belong to Mirai Labs; this IA documents the clone's own code structure, not a page it owns rights to (see design-repo/registry.manifest.json's sourceProject note and README.md).
